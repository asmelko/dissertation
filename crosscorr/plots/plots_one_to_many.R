...
{
    data = read.csv('../data/ampere/one_to_many_saturated/multimat-right.csv', header=T, sep=',')
...
{
    data = read.csv('../data/ampere/one_to_many_saturated/multimat-right-multirow-both.csv', header=T, sep=',')
    data = data.frame(data %>% group_by_at(names(data)[-grep("(Kernel)|(Kernel_iterations)|(X)|(Args)", names(data))]) %>% summarise(Kernel = mean(Kernel)))
...
{
    data = read.csv('../data/ampere/one_to_many/multimat-right-multirow-both.csv', header=T, sep=',')
    data = data.frame(data %>% group_by_at(names(data)[-grep("(Kernel)|(Kernel_iterations)|(X)|(Args)", names(data))]) %>% summarise(Kernel = mean(Kernel)))
...
{
    data = read.csv('../data/ampere/one_to_many/multimat-right-work-distribution.csv', header=T, sep=',')
    data = data.frame(data %>% group_by_at(names(data)[-grep("(Kernel)|(Kernel_iterations)|(X)|(Args)", names(data))]) %>% summarise(Kernel = mean(Kernel)))

    data = subset(data, distribution_type == "triangle")

    data_basic = read.csv('../data/ampere/one_to_many/multimat-right.csv', header=T, sep=',')
...

{
    ...
    data_original = read.csv('../data/ampere/one_to_many/original.csv', header=T, sep=',')
    ...
    data_fft = read.csv('../data/ampere/one_to_many/fft.csv', header=T, sep=',')
    data_fft["alg"] = "fft"
    ...
    data_fft2 = read.csv('../data/ampere/one_to_many/fft.csv', header=T, sep=',')
