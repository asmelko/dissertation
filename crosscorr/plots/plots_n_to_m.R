...
{
    data = read.csv('../data/ampere/n_to_m_saturated/multimat-both.csv', header=T, sep=',')
...
{
    data = read.csv('../data/ampere/n_to_m_saturated/multimat-both-multirow-both.csv', header=T, sep=',')
    data = data.frame(data %>% group_by_at(names(data)[-grep("(Kernel)|(Kernel_iterations)|(X)|(Args)", names(data))]) %>% summarise(Kernel = mean(Kernel)))
...
{
    data = read.csv('../data/ampere/n_to_m/multimat-both-work-distribution.csv', header=T, sep=',')

    data = subset(data, distribution_type == "triangle")

    data_basic = read.csv('../data/ampere/n_to_m/multimat-both.csv', header=T, sep=',')
...

{
    ...
    data_original = read.csv('../data/ampere/n_to_m/original.csv', header=T, sep=',')
    ...
    data_wd = read.csv('../data/ampere/n_to_m/multimat-both-work-distribution.csv', header=T, sep=',')
    ...
    data_mb = read.csv('../data/ampere/n_to_m/multimat-both-multirow-both.csv', header=T, sep=',')
    ...
    data_fft = read.csv('../data/ampere/n_to_m/fft.csv', header=T, sep=',')
    ...
    data_fft2 = read.csv('../data/ampere/n_to_m/fft.csv', header=T, sep=',')
