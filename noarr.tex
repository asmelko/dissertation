...
The traverser extracts dimensions from the passed-in layouts and yields an index space corresponding to the cartesian product of the extracted dimensions (after removing duplicates). Thanks to that specific dimension naming, the index space is congruent with the layout with $3$ dimensions, iterable the same way as in the plain example.
